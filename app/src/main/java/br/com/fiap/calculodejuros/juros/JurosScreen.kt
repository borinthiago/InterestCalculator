...
@Composable
fun JurosScreen(jurosScreenViewModel: JurosScreenViewModel) { // view
        ...
        Column {
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(
                        text = "Dados do Investimento" , fontWeight = FontWeight.Bold
                    )

                    //Caixa Valor
                    CaixaDeEntrada(label = "Valor do investimento" ,
                    ...
                    //Caixa Taxa
                    CaixaDeEntrada(label = "Taxa de juros mensal" ,
                    ...
                    // Caixa Tempo
                    CaixaDeEntrada(label = "Período em meses" ,
